...
const translations: Record<string, Record<Language, string>> = {
  ...
  'project7.desc': { pt: 'SaaS completo de agendamento para barbearias, com site institucional e sistema de gestão com três níveis de permissão. Acessos demo — Dono: dono@vasco.demo | VascoDemo123! · Barbeiro: barbeiro1@vasco.demo | VascoDemo123!', en: 'Full SaaS scheduling system for barbershops, with an institutional site and a management system with three permission levels. Demo access — Owner: dono@vasco.demo | VascoDemo123! · Barber: barbeiro1@vasco.demo | VascoDemo123!', es: 'SaaS completo de agendamiento para barberías, con sitio institucional y sistema de gestión con tres niveles de permiso. Accesos demo — Dueño: dono@vasco.demo | VascoDemo123! · Barbero: barbeiro1@vasco.demo | VascoDemo123!' },
  'project7.challenge': {
  ...
  'project7.highlight5': { pt: 'Acessos demo — Dono: dono@vasco.demo | VascoDemo123! · Barbeiro: barbeiro1@vasco.demo | VascoDemo123!', en: 'Demo access — Owner: dono@vasco.demo | VascoDemo123! · Barber: barbeiro1@vasco.demo | VascoDemo123!', es: 'Accesos demo — Dueño: dono@vasco.demo | VascoDemo123! · Barbero: barbeiro1@vasco.demo | VascoDemo123!' },
